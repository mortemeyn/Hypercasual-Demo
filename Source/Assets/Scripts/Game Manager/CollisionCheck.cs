...
{
    private Vector3 startPos = new Vector3(0f, 0.05420721f, 0f);
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            go.GetComponent<PlayerRank>().ResetTheProgress();
        ...
        else if (go.CompareTag("Opponent"))
        {
            ...
            go.GetComponent<OpponentController>().agent.SetDestination(new Vector3(Random.Range(-9f, 9f), transform.position.y, 192));
